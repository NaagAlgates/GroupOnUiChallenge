...
Widget appMenu(BuildContext context, TickerProvider provider) {
  ...
  ).animate(new CurvedAnimation(parent: _controller, curve: Curves.easeInOutBack));
    ...
    child: Stack(
      children: <Widget>[
        PositionedTransition(
          ...
          child: Padding(
          padding: const EdgeInsets.only(left: 8.0,bottom: 8.0,top: 6.0,right: 8.0),
          child: ListView(
            ...
            children: <Widget>[
              ...
              Padding(
                padding: const EdgeInsets.only(top: 2.0,bottom: 2.0,right: 8.0,left: 8.0),
                child: menuList(context,"Restaurants",Icons.restaurant),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 2.0,bottom: 2.0,right: 8.0,left: 2.0),
                child: menuList(context,"Shopping",Icons.shopping_basket),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 2.0,bottom: 2.0,right: 8.0,left: 2.0),
                child: menuList(context,"Things to do",Icons.confirmation_number),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 2.0,bottom: 2.0,right: 8.0,left: 2.0),
              ...
              Padding(
                ...
                child: menuList(context,"Health & Fitness",Icons.fitness_center),
              ),
            ],
          ),
      ),
    ...
    child: Container(
      ...
      child: Center(
          ...
          child: Row(children: <Widget>[
            ...
            SizedBox(width: 4.0,),
            Text(title,style: TextStyle(color: Colors.white,fontSize: 13.0),),
          ],)
      )),
    ),
  );
