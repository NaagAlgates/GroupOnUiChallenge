...
final md.Color defaultOnSelectColor = groupOnThemeData.primaryColor;

class GroupOnBottomNavigationBar extends md.StatefulWidget {
  final int index;
  ...
  @override
  GroupOnBottomNavigationBarState createState() => GroupOnBottomNavigationBarState();
}

class GroupOnBottomNavigationBarState extends md.State<GroupOnBottomNavigationBar> {
  int currentIndex;
  IconStyle iconStyle;
